...
const GROUPS: ShortcutGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { keys: "+ / −", label: "Aproximar / afastar" },
      { keys: "0", label: "Zoom em 100%" },
      { keys: "Ctrl + D", label: "Duplicar seleção" },
      { keys: "Ctrl + A", label: "Selecionar tudo" },
      { keys: "Ctrl + C / X / V", label: "Copiar / recortar / colar blocos" },
      { keys: "Ctrl + Z / Y", label: "Desfazer / refazer" },
      { keys: "Shift ou Ctrl + clique", label: "Somar ou tirar item da seleção" },
      { keys: "Shift + marquee", label: "Somar o retângulo à seleção" },
